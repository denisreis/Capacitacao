...
function addFormRCInfo($name,$surname,$career,$occupation,$workload,$institution_name,$type_instituition,$level_of_education,$level_incomplete_education,$knowledge_area,$finality,$modality,$relationship_with_objectives,$observation){
	$sql = "insert into Rel_Cap_Qua(name,surname,career,occupation,workload,institution_name,type_instituition,level_of_education,level_incomplete_education,knowledge_area,finality,modality,relationship_with_objectives,observation)"
